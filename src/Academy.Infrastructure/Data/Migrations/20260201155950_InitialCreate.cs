        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserProfiles_Academies_AcademyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    InstructorUserId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Branches_AcademyId_Name",
                table: "Branches",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_AcademyId_GroupId",
                table: "Enrollments",
                columns: new[] { "AcademyId", "GroupId" });

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_AcademyId_StudentId",
                table: "Enrollments",
                columns: new[] { "AcademyId", "StudentId" });

            migrationBuilder.CreateIndex(
                name: "IX_Enrollments_AcademyId_StudentId_GroupId_StartDate",
                table: "Enrollments",
                columns: new[] { "AcademyId", "StudentId", "GroupId", "StartDate" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamQuestions_AcademyId_ExamId_QuestionId",
                table: "ExamQuestions",
                columns: new[] { "AcademyId", "ExamId", "QuestionId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_AcademyId_UserId",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionOptions_AcademyId_QuestionId",
                table: "QuestionOptions",
                columns: new[] { "AcademyId", "QuestionId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_AcademyId",
                table: "UserProfiles",
                column: "AcademyId");
